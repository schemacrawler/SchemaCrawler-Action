...
```bash
git tag v17.11.2
git push origin v17.11.2
```

The release workflow:
1. Validates the semver tag format.
2. Creates a GitHub release with auto-generated release notes.
3. Builds a multi-platform Docker image (`linux/amd64`, `linux/arm64`) and pushes to Docker Hub with hierarchical version tags (`v17.11.2`, `17.11.2`, `17.10`, `17`).
